<template>
    <div>
        <div v-if="loading.event">
            <spinner :loading="loading.event" :colour="borderColour"></spinner>
        </div>
        <div v-if="loading.event">
            <div ref="sprite" class="sprite h-4 bg-blue-200"></div>
        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            nextEvent() {
                // TODO: add a time delay to make sure the animation always runs.
